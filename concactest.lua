...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>ANH ĐÃ QUAY TRỞ LẠI!!!<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thì TNVT đã trở lại!!!!!<Color=/>"):Display()
    wait(.14)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Channel : NO <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/ThuanzrNguyenz/tnxvthub/main/tnvtmain.lua"))()
local Window = OrionLib:MakeWindow({Name = "TN X VT Hub", HidePremium = false, IntroText = "TNVTHUB LEGENDARY", SaveConfig = true, ConfigFolder = "TN X VT Hub"})

OrionLib:MakeNotification({
	Name = "TN VT HUB",
	Content = "Choose Teams Bro?",
	Image = "rbxassetid://16161727880",
	Time = 7
})
...
W:AddLabel("Script By TNVT")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] TN X VT Hub is back!")
W:AddLabel("[+] I Not Skidder!")
W:AddLabel("[+] I WILL BE AS STRONG AS I CAN!!!")
...
local locallv = W:AddLabel("Level")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : Chưa Có")
...
M:AddParagraph("Kaitun/Cantay","Kaitun ")
